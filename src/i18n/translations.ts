...
export const translations = {
  zh: {
    ...
    'game.tab_alignment': '🛡️ 守備配置圖',
    'game.tab_lineup': '📋 打序與換人',
    'game.tab_box': '📊 完整 Box 數據',
    'game.alignment_title': '守備配置圖',
    'game.alignment_note': '＊ 標示為替補上場；數字為守備位置代號 1–9',
  ...
  en: {
    ...
    'game.tab_alignment': '🛡️ Defensive Alignment',
    'game.tab_lineup': '📋 Lineup & Substitutions',
    'game.tab_box': '📊 Full Box Score',
    'game.alignment_title': 'Defensive Alignment',
    'game.alignment_note': '* entered as a substitute; numbers are scorekeeping positions 1-9',
